...
int CSingleShapeDecorator::GetOutlineThickness() const
{
	return m_shape->getOutlineThickness();
}

sf::Color CSingleShapeDecorator::GetOutlineColor() const
{
	return m_shape->getOutlineColor();
}

sf::Color CSingleShapeDecorator::GetFillColor() const
{
